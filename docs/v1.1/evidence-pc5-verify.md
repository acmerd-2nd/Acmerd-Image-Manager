...
(node:53480) Warning: Setting the NODE_TLS_REJECT_UNAUTHORIZED environment variable to '0' makes TLS connections and HTTPS requests insecure by disabling certificate verification.
(Use `node --trace-warnings ...` to show where the warning was created)
  PASS  R1b 用户已由 Worker 建号（admin 列表可见） — id=b036223d-2544-43cb-b9a2-3f92f1ba13a3
