...
export function ConfirmDialog({
  ...
  if (!open) return null
  return (
    <div className="modal-backdrop fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-[2px]" onClick={onCancel}>
      <div
        ref={panelRef}
        className="modal-panel w-full max-w-md rounded-lg border bg-background p-6 shadow-lg"
